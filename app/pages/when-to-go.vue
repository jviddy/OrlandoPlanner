...
<template>
  <main class="when-page">
    <header>
      <nav class="page-links" aria-label="Crowd planning pages">
        <NuxtLink to="/new">← Start a trip</NuxtLink>
        <NuxtLink to="/crowds">Historical &amp; projected crowd data →</NuxtLink>
      </nav>
