...
<template>
  <main class="crowds" :class="{ 'planning-mode': zoom === 'planning' || zoom === 'planning-week' }">
    <header class="hero">
      <nav class="hero-links" aria-label="Crowd planning pages"><NuxtLink to="/">← Trip planner</NuxtLink><NuxtLink to="/when-to-go">Find the best time to visit →</NuxtLink></nav>
...
.crowds{flex:1;min-height:0;overflow:auto;background:#faf8f2;color:#233a38;padding:28px;font-family:var(--font-ui)}
