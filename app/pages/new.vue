    ...
    <ClientOnly>
      <div class="scroll setup__body">
        ...
        <section v-if="setup.step === 0" class="setup__panel">
          ...
          <div class="setup__optional-divider"><span>Still choosing dates?</span></div>
          <NuxtLink class="route-card route-card--link" to="/when-to-go"><strong>Find the best time to visit</strong><span>Compare predicted crowds and find the strongest dates before you start your trip.</span></NuxtLink>
        </section>
...
.route-card--link{color:inherit;text-decoration:none}.route-card--link:hover{border-color:var(--c-navy)}
